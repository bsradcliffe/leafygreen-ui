...
import { BlobSVGProps } from './BlobSVG.types';

type BlobSVGProperties = 'viewBox' | 'path' | 'styles';
...
const blobSVGPaths: Record<BlobPosition, Record<BlobSVGProperties, string>> = {
  [BlobPosition.TopLeft]: {
    ...
    styles: 'top-0 left-0 w-[265px] max-w-[80%]',
  },
  [BlobPosition.TopRight]: {
    ...
    styles: 'top-0 right-0 w-[342px] max-w-[80%]',
  },
  [BlobPosition.BottomRight]: {
    ...
    styles: 'right-0 bottom-0 w-[322px] max-w-[70%]',
  },
};
...
export const BlobSVG = ({ blobPosition, theme }: BlobSVGProps) => {
  ...
  return (
    <svg
      ...
      className={cn(baseStyles, themeStyles[theme], positionStyles)}
      aria-hidden="true"
